...
const logger = createLogger('retro-gaming');
...
app.get('/', (req, res) => {
  res.json({ 
    message: 'Hello from retro_gaming!',
    project: 'nself-tv',
    framework: 'Express',
    version: '4.18.2'
  });
...
app.use((err, req, res, next) => {
  const logger = req.logger || createLogger('retro-gaming');
...
const server = app.listen(PORT, () => {
  logger.info('Retro Gaming service started', {
    port: PORT,
