...
Business services that implement orchestration and policy-aware behavior beyond raw CRUD.
...
Implement auth/orchestrator/stream-gateway/scheduler/jobs service contracts.
